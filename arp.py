...
def arp_reply(sock, packet: bytes) -> bytes:
    ...
    :return: Tha ARP protocol reply data, the destination mac and the source mac.
    """
    ...
    return reply_data, src_mac, dst_mac #src_mac is the destination of the reply, and dst_mac is the source.
